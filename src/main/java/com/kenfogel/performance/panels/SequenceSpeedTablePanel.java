...
/**
 * Panel for sequence test results
 *
 * @author neon
 * @version 3.0
 *
...
public class SequenceSpeedTablePanel extends JPanel {
     ...
     */
    public SequenceSpeedTablePanel(SequenceSpeedTableModel sequenceSpeedTableModel) {
        super(new GridLayout(1, 0));

        table = new JTable(sequenceSpeedTableModel);
        initialize();
    }
    ...
    private void initialize() {
        ...
        table.setPreferredScrollableViewportSize(new Dimension(785, 200));
